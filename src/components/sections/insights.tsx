      ...
      <div className="max-w-300 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <motion.div
            ...
            className="md:row-span-2 group relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/60 p-8 flex flex-col justify-between min-h-[420px] hover:shadow-xl hover:shadow-slate-900/5 dark:hover:shadow-black/20 transition-shadow duration-500"
          >
            ...
            <div className="relative mt-8 flex-1 rounded-2xl bg-gradient-to-br from-indigo-50 to-slate-50 dark:from-indigo-950/30 dark:to-slate-900/50 border border-indigo-100/60 dark:border-indigo-900/30 flex items-end p-6 overflow-hidden">
          ...
          <motion.div
            ...
            className="group relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/60 p-8 flex items-center justify-between gap-6 min-h-[200px] hover:shadow-xl hover:shadow-slate-900/5 dark:hover:shadow-black/20 transition-shadow duration-500"
          >
